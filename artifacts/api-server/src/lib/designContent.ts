...
export async function generateDesignContent(input: DesignContentInput): Promise<DesignContent> {
  ...
  const userPrompt = [
    ...
    "",
    "5. **materials** — таблица «Рекомендуемые материалы (РФ)» (5-7 строк). Категории: Стены, Акцентная стена (если есть), Пол, Плинтус, Потолок, Дверь, при необходимости — Сантехника или Фурнитура. ОБЯЗАТЕЛЬНО указывай конкретный бренд/коллекцию, реально доступный в России, + тип и параметры. Ориентир по брендам (выбирай уместный под стиль и бюджет, можно и другие реальные РФ-бренды):",
    "   • Краска: Dulux, Tikkurila, Finncolor, Текс, Belinka",
    "   • Ламинат/паркетная доска: Quick-Step, Egger, Tarkett, Kronospan, Alpine Floor",
    "   • Плитка/керамогранит: Kerama Marazzi, Cersanit, Estima, Italon, Laparet",
    "   • Двери: Profil Doors, Волховец, Дера, Океан",
    "   • Сантехника/смесители: Grohe, Hansgrohe, AM.PM, Cersanit, IDDIS",
    "   • Стеновые панели/рейки: Stella, Ultrawood, МДФ-рейки шпон дуба",
    "   • Мебельная фурнитура: Blum, Hettich, Boyard",
    "   Пример строки: категория «Пол», описание «Ламинат Quick-Step Eligna 32 класс, дуб натуральный, 8 мм».",
    "",
