...
import { X, Share, Plus, Handshake } from "lucide-react";

const DISMISSED_KEY = "partner-pwa-install-dismissed-v1";
          ...
          {showIos ? (
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-gray-900">Сфера Партнёр</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-gray-900 text-sm">Сфера Партнёр</p>
