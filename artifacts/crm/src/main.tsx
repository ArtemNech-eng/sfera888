...
// After a deploy, the cached HTML may point to deleted /assets/*.js — Vite throws
// "Failed to fetch dynamically imported module". Reload once to pick up fresh HTML.
...
const tryReloadOnChunkError = (msg: string) => {
  ...
  if (Date.now() - last < 10_000) return; // already reloaded recently — avoid loop
