...
const MESSAGE_TEMPLATES: Record<string, { label: string; text: (o: OrderCtx) => string }[]> = {
  no_estimate: [
    ...
    { label: "Когда смета?", text: (o) => `Добрый день! По заказу${orderLabel(o)} — когда будет готова смета? Напишите примерный срок.` },
  ...
  no_master_response: [
    ...
    { label: "Новости по заказу", text: (o) => `Добрый день! По заказу${orderLabel(o)} — какие новости? Ждём вашего ответа.` },
    { label: "Когда ответ?", text: (o) => `Добрый день! По заказу${orderLabel(o)} — когда сможете ответить? Клиент ждёт.` },
  ],
  blocked_master: [
  ...
  possible_bypass: [
    ...
    { label: "Новости по заказу", text: (o) => `Добрый день! По заказу${orderLabel(o)} — какие новости? Обновите статус в приложении.` },
    { label: "Работайте через платформу", text: (o) => `По заказу${orderLabel(o)}: все расчёты и общение с клиентом — только через платформу. Это обязательно.` },
  ],
  conflict: [
    ...
    { label: "Новости по заказу", text: (o) => `Добрый день! По заказу${orderLabel(o)} — какие новости? Нужно урегулировать ситуацию.` },
    { label: "Урегулируйте конфликт", text: (o) => `По заказу${orderLabel(o)}: свяжитесь с нами для разрешения конфликта с клиентом.` },
  ],
  no_progress: [
