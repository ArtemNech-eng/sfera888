...
const HowItWorks: React.FC = () => {
  const steps = [
    {
      icon: <Package size={28} className="text-[#10B981]" />,
      step: '01',
      title: 'Взял объект',
    ...
    {
      icon: <Wrench size={28} className="text-[#3B82F6]" />,
      step: '02',
      title: 'Сделал',
    ...
    {
      icon: <CheckCircle size={28} className="text-[#F59E0B]" />,
      step: '03',
      title: 'Закрыл',
    ...
    {
      icon: <Star size={28} className="text-[#10B981]" />,
      step: '04',
      title: 'Взял новый',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-[#0F172A] mb-4">
            Принцип конвейера:
            <br />
            <span className="text-[#10B981]">Взял → Сделал → Взял новый</span>
          </h2>
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-12 left-[12.5%] right-[12.5%] h-[1px]"
            style={{
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, i) => (
              <AnimatedSection key={i} delay={i * 120} direction="up">
                <div className="relative glass rounded-2xl p-6 hover:shadow-md transition-all duration-300 group">
                  {/* Step number */}
                  <div className="text-6xl font-black text-[#10B981]/10 absolute top-4 right-4 select-none leading-none">
                    {step.step}
                  </div>

                  {/* Icon */}
                  <div className="w-14 h-14 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
                    {step.icon}
                  </div>
        ...
        <AnimatedSection delay={500} className="mt-10 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-[#F59E0B]/8 border border-[#F59E0B]/20">
