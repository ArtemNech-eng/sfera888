...
const WhoWeHire: React.FC = () => {
  ...
  return (
    <section id="who-we-hire" className="relative py-24 bg-[#0B0F14] overflow-hidden">
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-[#F8FAFC] mb-4">
            С кем мы{' '}
            <span className="text-[#38BDF8]">работаем</span>
          </h2>
            ...
            <div className="glass rounded-3xl p-8 h-full">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-[#34F5A3]/10 flex items-center justify-center">
                  <Users size={20} className="text-[#34F5A3]" />
                </div>
                <h3 className="text-[#F8FAFC] font-black text-xl">Кого берём</h3>
              </div>
              ...
              <div className="mt-6 p-4 rounded-2xl bg-[#34F5A3]/5 border border-[#34F5A3]/10">
                <p className="text-[#94A3B8] text-sm">
                  <span className="text-[#34F5A3] font-semibold">Нужен опыт</span> — мы работаем
          ...
          <AnimatedSection delay={200} direction="right">
            <div className="glass rounded-3xl p-8 h-full">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-[#F8FAFC] font-black text-xl">Правила платформы</h3>
              </div>
                  ...
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span
                      className={`text-sm leading-relaxed ${
                        rule.ok ? 'text-[#F8FAFC]' : 'text-[#94A3B8]'
                      }`}
                    >
                      {rule.text}
                    </span>
