  ...
  return (
    <section className="relative py-28 bg-[#0F172A] overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 50% 100%, rgba(52,245,163,0.18) 0%, transparent 60%)',
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <AnimatedSection direction="fade">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-8"
            style={{
              ...
              boxShadow: '0 0 30px rgba(52,245,163,0.2)',
            }}
          >
            <Zap size={36} className="text-[#34F5A3]" />
          </div>
        </AnimatedSection>

        <AnimatedSection delay={100}>
          <h2 className="text-5xl sm:text-6xl lg:text-7xl font-black text-[#F8FAFC] leading-[1.05] mb-6">
            Хватит искать{' '}
            <br />
            <span
              style={{
        ...
        <AnimatedSection delay={300}>
          <a
            ...
            className="group relative inline-flex items-center justify-center gap-3 px-10 py-6 rounded-2xl font-black text-xl text-[#0B0F14] transition-all duration-300 hover:scale-105 active:scale-95"
            style={{
              background: '#34F5A3',
              boxShadow:
                '0 0 30px rgba(52,245,163,0.5), 0 0 60px rgba(52,245,163,0.25), 0 0 100px rgba(52,245,163,0.1)',
            }}
          >
            {/* Shimmer effect */}
            <span
            ...
            <span className="relative">Перейти в бота и начать работу</span>
            <ArrowRight size={24} className="relative transition-transform group-hover:translate-x-1" />
          </a>
        </AnimatedSection>

        <AnimatedSection delay={400}>
          <p className="text-[#94A3B8]/60 text-sm mt-6">
            Telegram-бот Max · Бесплатная регистрация · Первый заказ сегодня
          </p>
        </AnimatedSection>

        {/* Stats */}
        <AnimatedSection delay={500}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mt-14 pt-10 border-t border-white/5">
            {[
