    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#10B981]/25 bg-[#10B981]/6 text-[#10B981] text-sm font-medium">
        ...
        <div className="text-center mb-6">
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-[1.05] tracking-tight text-[#0F172A] mb-4">
            Заказы для мастеров.
            <br />
        ...
        {/* Subtitle */}
        <p className="text-center text-[#64748B] text-lg sm:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-12">
          {[
            ...
            <div key={i} className="flex items-center gap-2 text-[#10B981] font-medium text-sm sm:text-base">
              {item.icon}
              <span>{item.text}</span>
            </div>
          ))}
        ...
        <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4 max-w-2xl mx-auto">
          <div className="flex-1 glass rounded-2xl px-6 py-4 flex items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-[#10B981]/8 flex items-center justify-center flex-shrink-0">
              <div className="w-3 h-3 rounded-full bg-[#10B981] animate-pulse" />
            </div>
            <div>
              <p className="text-[#0F172A] font-semibold text-sm">Новые объекты</p>
              <p className="text-[#64748B] text-xs">каждый день в системе</p>
            </div>
          </div>
          <div className="flex-1 glass rounded-2xl px-6 py-4 flex items-center gap-4">
            ...
            <div>
              <p className="text-[#0F172A] font-semibold text-sm">Стабильный поток</p>
              <p className="text-[#64748B] text-xs">заявок без простоев</p>
            </div>
          </div>
        </div>
      </div>
