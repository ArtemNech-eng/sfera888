...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Мы городской сервис, который объединяет проверенных частных мастеров. Не строительная фирма с накрутками, а сервис проверенных мастеров.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Мы поможем найти другого мастера. Свяжитесь с нами, и мы подберём замену.',
  },
];
