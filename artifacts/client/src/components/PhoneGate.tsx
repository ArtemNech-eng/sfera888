  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ width: 30, height: 30, background: "linear-gradient(135deg,#0F4C45,#0D9488)", borderRadius: 9, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
            <polyline points="14 2 14 8 20 8"/>
          </svg>
        </div>
        <span style={{ fontSize: 15, fontWeight: 700, color: "#0D2B28" }}>Честный мастер</span>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "20px 24px" }}>
        ...
        <div style={{
          ...
          marginBottom: 24, boxShadow: "0 8px 28px rgba(13,148,136,.25)",
        }}>
        ...
        <h1 style={{ fontSize: 22, fontWeight: 800, color: "#0D2B28", marginBottom: 10, textAlign: "center", letterSpacing: -0.5 }}>
          Подтвердите номер
        </h1>
        <p style={{ fontSize: 14, color: "#4A6B69", textAlign: "center", lineHeight: 1.6, marginBottom: 28, maxWidth: 300 }}>
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              width: "100%", height: 54,
              border: `1.5px solid ${error ? "#ef4444" : "#D0EDEB"}`,
              borderRadius: 14, padding: "0 18px",
              fontSize: 20, fontFamily: "inherit",
              color: "#0D2B28", background: "#fff",
              outline: "none", boxSizing: "border-box",
              textAlign: "center", letterSpacing: 1,
              transition: "border-color 0.15s",
              boxShadow: "0 1px 4px rgba(13,148,136,.06)",
            }}
          />
          {error && (
        ...
        <p style={{ fontSize: 12, color: "#4A6B69", textAlign: "center", marginTop: 16, lineHeight: 1.5, maxWidth: 280 }}>
