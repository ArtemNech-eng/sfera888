  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: 15, fontWeight: 700, color: "#1a1040" }}>Честный мастер</span>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "20px 24px" }}>
        ...
        <div style={{
          ...
          marginBottom: 24, boxShadow: "0 8px 28px rgba(29,78,216,.25)",
        }}>
        ...
        <h1 style={{ fontSize: 22, fontWeight: 800, color: "#1a1040", marginBottom: 10, textAlign: "center", letterSpacing: -0.5 }}>
          Подтвердите номер
        </h1>
        <p style={{ fontSize: 14, color: "#9490b4", textAlign: "center", lineHeight: 1.6, marginBottom: 28, maxWidth: 300 }}>
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              width: "100%", height: 54,
              border: `1.5px solid ${error ? "#ef4444" : "#ede9fc"}`,
              borderRadius: 14, padding: "0 18px",
              fontSize: 20, fontFamily: "inherit",
              color: "#1a1040", background: "#fff",
        ...
        <p style={{ fontSize: 12, color: "#9490b4", textAlign: "center", marginTop: 16, lineHeight: 1.5, maxWidth: 280 }}>
