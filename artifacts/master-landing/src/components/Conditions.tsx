      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-4xl mx-auto mt-10 p-6 rounded-2xl bg-white border-2 border-[#D9342B]/20 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-[#0F172A] font-semibold mb-1">Важно: если клиент не заплатил — вы ничего не должны.</p>
              <p className="text-[#475569] text-sm">Риск на нас. Вы оплачиваете комиссию только после получения денег от клиента.</p>
            </div>
          </div>
        </div>
      </div>
