# Договор о порядке передачи заказов и вознаграждении агента
...
ИП Коваленко Игорь Геннадьевич, действующий на основании государственной регистрации (далее — «Агент»), с одной стороны, и гражданин(ка) **[ФИО]**, **[паспорт]**, **[дата выдачи]** **[кем выдан]**, проживающий(ая) по адресу: **[адрес]**, **[телефон]**, (далее — «Мастер»), с другой стороны, совместно — «Стороны», заключили настоящий договор о нижеследующем.
...
**4.1.** После каждого выполненного заказа Мастер обязан предоставить Агенту одним сообщением в мессенджере:

- заполненный акт выполненных работ с подписью Клиента;
- фото объекта «до» начала работ (не менее 2 шт.);
- фото объекта «после» завершения работ (не менее 3 шт.);
...
- приезжать вовремя;
- при опоздании — предупредить Клиента не менее чем за 2 часа;
- работать аккуратно и по технологии;
- застелить полы, закрыть мебель;
- убрать за собой после завершения работ;
- не курить в помещении Клиента;
- не употреблять алкоголь на объекте.
