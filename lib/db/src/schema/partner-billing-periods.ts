...
export const partnerBillingPeriodsTable = pgTable("partner_billing_periods", {
  ...
  holdLeadsCount: integer("hold_leads_count").notNull().default(0),
  holdEarned: numeric("hold_earned", { precision: 10, scale: 2 }).notNull().default("0"),
  adBudget: numeric("ad_budget", { precision: 10, scale: 2 }).notNull().default("0"),
